...
{
    Console.WriteLine("Usage: pwsh-aot-lite [--color auto|always|never] [-Command <script>] [--complete <incomplete-line>] [<script>]");
...
Environment.ExitCode = ScriptRunner.Execute(script, colorMode: colorMode);
