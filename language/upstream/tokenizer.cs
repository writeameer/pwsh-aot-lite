...
namespace System.Management.Automation.Language
{
    ...
    public class DynamicKeyword
    {
        ...
        public static void Reset()
        {
            ...
            AotLanguageDiagnostics.ThrowDynamicKeywordRegistryExcluded();
#else
        ...
        {
#if PWSH_AOT_LANGUAGE_EXCLUDE_DSC
            // The parser still asks this question while scanning identifiers.
            // A sealed empty registry preserves ordinary command parsing while
            // making parser-time dynamic delegates unrepresentable.
            return null;
#else
        ...
        {
#if PWSH_AOT_LANGUAGE_EXCLUDE_DSC
            return new List<DynamicKeyword>();
#else
        ...
        {
#if PWSH_AOT_LANGUAGE_EXCLUDE_DSC
            // Do not allocate or consult the thread-local upstream registry.
            // Returning false prevents tokenizer classification as a dynamic
            // keyword, and therefore prevents Parser from invoking PreParse.
            return false;
#else
