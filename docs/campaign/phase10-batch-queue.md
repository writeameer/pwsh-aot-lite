...
- Accounting: 288 logical commands; 8 completed commands (5 baseline and 3 integrated during this campaign); 280 queued commands in 28 batches of ten (final queued batch may be smaller).
...
## B01 — completed-integrated (3 commands)
