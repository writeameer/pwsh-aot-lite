...
| `Get-Item` | 2026-09-22T22:25:55.0487520Z | — | — | Wave 3 captured-root direct physical file-or-directory lookup slice; no provider, wildcard, or dynamic-parameter support. | in progress |
