...
| `Get-Member` | unavailable (not recorded) | 2026-09-25T10:02:34.1149010Z | unavailable (start not recorded) | J2 exact static TextRecord `Name Length` metadata subset; managed/native evidence verified and main release complete at `acd4232`. | integrated |
