...
| `Get-Unique` | unavailable (not recorded) | 2026-09-25T09:26:31.9066670Z | unavailable (start not recorded) | J2 explicit `AsString` static TextRecord pipeline subset; managed/native evidence verified. | release-pending |
