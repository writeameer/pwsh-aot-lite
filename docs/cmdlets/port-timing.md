...
| `Get-Member` | unavailable (not recorded) | 2026-09-25T10:01:39.2663190Z | unavailable (start not recorded) | J2 exact static TextRecord `Name Length` metadata subset; managed/native evidence verified. | release-pending |
