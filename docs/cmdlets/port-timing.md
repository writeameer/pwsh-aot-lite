...
| `Measure-Object` | unavailable (not recorded) | 2026-09-25T09:16:41.7643560Z | unavailable (start not recorded) | J2 direct named one-string TextMeasure (`Character`/`Word`/`Line`/`IgnoreWhiteSpace`) subset; managed/native evidence verified. | release-pending |
