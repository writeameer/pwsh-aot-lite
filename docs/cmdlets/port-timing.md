...
| `Get-SecureRandom` | unavailable (not recorded) | pending main release | pending main release | J2 named cryptographic Int32 (`Minimum`/`Maximum`) direct numeric subset; managed/native evidence complete. | release-pending |
