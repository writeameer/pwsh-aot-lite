...
| `Test-Path` | in progress: bounded Wave 3 macOS-arm64 captured-root direct physical existence/kind probe; provider, literal, wildcard, `IsValid`, pipeline, and dynamic-parameter support remain deferred/fail closed | [Test-Path port notes](cmdlets/test-path.md) |
